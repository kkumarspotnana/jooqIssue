...
public class Citext3 extends AbstractRoutine<String> {
     ...
     */
    public static final Parameter<Inet> _1 = Internal.createParameter("_1", DefaultDataType.getDefaultDataType("\"pg_catalog\".\"inet\""), false, true, new InetBinding());
     ...
     */
    public void set__1(Field<Inet> field) {
        setField(_1, field);
    }
}
