...
public class RegexpSplitToTable extends TableImpl<RegexpSplitToTableRecord> {
    ...
    private RegexpSplitToTable(Name alias, Table<RegexpSplitToTableRecord> aliased) {
        this(alias, aliased, new Field[] {
            DSL.val(null, DefaultDataType.getDefaultDataType("\"public\".\"citext\"").asConvertedDataType(new CitextBinding())),
            DSL.val(null, DefaultDataType.getDefaultDataType("\"public\".\"citext\"").asConvertedDataType(new CitextBinding()))
        });
    }
    ...
    public RegexpSplitToTable call(
        ...
        RegexpSplitToTable result = new RegexpSplitToTable(DSL.name("regexp_split_to_table"), null, new Field[] {
            DSL.val(__1, DefaultDataType.getDefaultDataType("\"public\".\"citext\"").asConvertedDataType(new CitextBinding())),
            DSL.val(__2, DefaultDataType.getDefaultDataType("\"public\".\"citext\"").asConvertedDataType(new CitextBinding()))
        });
